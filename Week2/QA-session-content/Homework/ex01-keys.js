...
"CREATE TABLE authors (author_no INT, author_name VARCHAR(255), university VARCHAR(255), date_of_birth DATE, h_index VARCHAR(255), gender ENUM('male', 'female'), PRIMARY KEY(author_no));",
